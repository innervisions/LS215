...
function sentiment(text) {
  let positiveMatches = text.toLowerCase().match(positiveRegex);
  let negativeMatches = text.toLowerCase().match(negativeRegex);
  ...
  let sentiment = positiveMatches.length - negativeMatches.length;
  if (sentiment > 0) {
